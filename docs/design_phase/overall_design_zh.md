...
├── SKILL.md                   # 主指令：如何对 tmp 和 context 增删查改
...
├── SKILL.md                   # 主指令：如何积累经验，何时创建/演化 skill
├── reference/                 # 参考文档
...
3. 将 `skills/user-context/` 复制到 `~/.claude/skills/user-context/`
4. 将 `skills/skill-evolver/` 复制到 `~/.claude/skills/skill-evolver/`
