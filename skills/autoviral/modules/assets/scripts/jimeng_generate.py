#!/usr/bin/env python3
"""
即梦 AI (VolcEngine) 视频生成工具
通过火山引擎 Visual API 生成视频。**图片生成能力已禁用**——图片请使用
`openrouter_generate.py`（openai/gpt-5.4-image-2）。
...
def main():
    parser = argparse.ArgumentParser(description="即梦 AI 视频生成工具（图片请用 openrouter_generate.py）")
