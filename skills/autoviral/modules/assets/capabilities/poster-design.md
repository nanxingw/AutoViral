...
```bash
# 查看所有可用字体
python3 skills/autoviral/modules/assets/scripts/font_manager.py --list

# 获取指定字体路径
python3 skills/autoviral/modules/assets/scripts/font_manager.py --font source-han-sans --weight bold
```
