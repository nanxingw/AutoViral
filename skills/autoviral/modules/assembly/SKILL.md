...
成片必须落在平台可接受的技术规格上。**这是工具约束，不是创作决策**。

| 平台 | 推荐尺寸 | 编码 | 码率 | 最大时长 | 最大大小 |
|---|---|---|---|---|---|
| 抖音 | 1080×1920 (9:16) | H.264 | 6-10 Mbps | 15 分钟 | 4 GB |
| 小红书视频 | 1080×1440 (3:4) 或 1080×1920 | H.264 | 4-8 Mbps | 15 分钟 | 500 MB |
| 视频号 | 1080×1920 / 1080×1080 | H.264 | 6-10 Mbps | 60 分钟 | 2 GB |
| YouTube Shorts | 1080×1920 | H.264/H.265 | 8-12 Mbps | 60 秒 | — |

**安全区**：视频底部 20% 会被平台 UI 遮挡（关注、评论、分享按钮）。关键字幕和关键画面**都要避开**。`subtitle_burn.py` 默认已避让；手动剪辑时要自己注意。

详细技术规范见 `references/douyin.md` 和 `references/xiaohongshu.md`（忽略其中的创作建议）。
