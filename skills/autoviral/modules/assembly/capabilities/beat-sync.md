...
```bash
python3 skills/autoviral/modules/assembly/scripts/beat-sync/beat_sync_edit.py \
  --video source.mp4 \
  --music bgm.mp3 \
  --output final.mp4 \
  --style fast
...
```bash
python3 skills/autoviral/modules/assembly/scripts/beat-sync/detect_beats.py bgm.mp3 -o beats.json
```
