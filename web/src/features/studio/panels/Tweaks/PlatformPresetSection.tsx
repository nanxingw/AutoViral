...
// S15 — the platform preset table now lives in @shared/platform-presets so
// this dropdown and the server-side render-pipeline read the SAME source. The
// component used to hard-code its own copy, which silently drifted from the
// values /export applied (issue #80: 微信/-16 lived only in render, never UI).
import { PLATFORM_PRESETS } from "@shared/platform-presets";

const PRESETS: readonly ExportPreset[] = PLATFORM_PRESETS;
