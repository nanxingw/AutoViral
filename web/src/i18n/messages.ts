  ...
  studio: {
    ...
    timeline: {
      ...
      trackHeader: {
        ...
        removeConfirmBodyEmpty: "This lane has no clips. Removing is reversible via Undo.",
        removeConfirmBodyClips: "About to orphan {count} clip(s). This is reversible via Undo, but the clips disappear with the lane.",
  ...
  studio: {
    ...
    timeline: {
      ...
      trackHeader: {
        ...
        removeConfirmBodyEmpty: "此轨道为空。删除后可通过撤销恢复。",
        removeConfirmBodyClips: "即将丢弃 {count} 个 clip。操作可撤销，但 clip 会随轨道一并消失。",
