...
export const en = {
  ...
  explore: {
    ...
    angleGenerateDisabled: "Sample data — one-click generation lands once the angles agent hook is wired.",
    angleGenerateCta: "Generate →",
    sampleScoreTitle: "Sample score — not yet from an algorithm",
    sampleSuffix: " · sample",
...
export const zh: DeepShape<Messages> = {
  ...
  explore: {
    ...
    angleGenerateDisabled: "占位推荐——智能体接入后才能一键生成作品。",
    angleGenerateCta: "生成 →",
    sampleScoreTitle: "演示评分——尚未来自算法",
    sampleSuffix: " · 演示",
